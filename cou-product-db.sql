...
-- Creating the table with the "type" column
CREATE TABLE products (
  id INT AUTO_INCREMENT PRIMARY KEY,
  name VARCHAR(40) NOT NULL,
  price DECIMAL(6, 2) NOT NULL, -- 6 numbers allowed, including decimal
  description VARCHAR(40) NOT NULL,
  image_url VARCHAR(255) NOT NULL, -- Links can be lengthy
  link VARCHAR(255) NOT NULL,
  alt_text VARCHAR(50) NOT NULL,
  type VARCHAR(10) NOT NULL -- New column for product type
);

-- Inserting data into the table, including the "type" column
INSERT INTO products (name, price, description, image_url, link, alt_text, type)
VALUES
('Keyboard', 34.99, 'Sleek, all black keyboard', 
 ...
 'Photo of a minimalist keyboard', 'Tech'),
('Coding T-Shirt', 29.99, 'Stylish programming T-shirt', 
 ...
 'Photo of a cute programming t-shirt', 'Clothes'),
('Hoodie', 20.99, 'Warm, snazzy programming hoodie', 
 ...
 'Photo of a programming hoodie', 'Clothes'),
('Stickers', 7.99, 'Sticker bomb book', 
 ...
 'Photo of a sticker book for laptops', 'Misc'),
('Beanie', 11.99, 'Linux beanie to hide your haircut', 
 ...
 'Photo of a programming beanie', 'Clothes'),
('Mouse', 22.99, 'A Bluetooth mouse', 
 ...
 'Photo of a computer mouse', 'Tech'),
('Mousepad', 9.99, 'Mousepad for your mouse', 
 ...
 'Photo of a mousepad for your mouse', 'Misc'),
('Headphones', 80.00, 'Noise-cancelling headphones', 
 ...
 'Photo of noise-cancelling headphones', 'Tech'),
('Backpack', 59.99, 'Minimalist Backpack for work/school', 
 ...
 'Photo of a minimalist backpack', 'Misc'),
('Mug', 12.50, 'Snazzy coffee mug', 
 ...
 'Photo of a funny mug for programmers', 'Misc'),
('Notebook', 14.99, 'Five subject divider notebook', 
 ...
 'Photo of a 5 subject divider notebook', 'Misc'),
('Sweatpants', 24.99, 'For the WFH coders', 
 ...
 'Photo of casual grey sweatpants', 'Clothes');
